 ...
 */
export const Card = ({ title, author, date, content, image, url }: ICard) => {
  return (
    <article className="h-full overflow-hidden rounded-xl border-2 bg-white">
      <div>
        <Image
        ...
        <div className="p-8">
          ...
          {content && <p className="mt-2 text-gray-dark">{content}</p>}
          {/* Display the date */}
          {date && (
